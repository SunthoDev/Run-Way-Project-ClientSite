...
import "./UserSearchParcelByNumber.css"
import { useLoaderData } from 'react-router-dom';
import { useQuery } from '@tanstack/react-query';
import { Link } from 'react-router-dom';

const UserSearchParcelByNumber = () => {

    let UserParcelInformationByNumber = useLoaderData()
    // console.log(UserParcelInformationByNumber)
        ...
        <div className='AdminViewPaymentRequestAll bg-[#F6F6F6]'>
            <div className='md:px-4 my-4'>
                ...
                <div className="bg-white p-6 rounded-xl shadow-md  mt-10">
                    ...
                    <h3 className='text-black text-[24px] font-[600] text-left pb-4'>All Category Parcel Show Here !!</h3>
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        {
                                            (UserParcelInformationByNumber?.slice().reverse().map((ParcelAll) =>
...
export default UserSearchParcelByNumber;