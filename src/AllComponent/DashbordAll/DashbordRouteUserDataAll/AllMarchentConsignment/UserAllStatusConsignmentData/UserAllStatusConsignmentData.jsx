...
import "./UserAllStatusConsignmentData.css"
import { Link } from 'react-router-dom';

const UserAllStatusConsignmentData = ({ConsignmentAll}) => {
    ...
    return (
        <Link to={`/dashboard/UserTemporeryInvoiceAllStandardData/${StandardParcelId}`} className='UserAllStatusConsignmentData'>

            <div className='AllStatusConsignmentData'>
...
export default UserAllStatusConsignmentData;