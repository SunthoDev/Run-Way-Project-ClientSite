...
const UserTemporeryInvoiceAllStandardData = () => {
    ...
    // =============================================================================================================
    // It was need for find a rider information, now i am save the rider information with parcel. So it's no need!!
    // =============================================================================================================
            ...
            {/* <div className="PrintAll hidden print:block text-black mb-10 w-[288px] h-[288px]" ref={LabelRef}>
                <div className="Prints">
                    ...
                    <div className="mt-2 text-center text-[10px]">
                        <p>https://trustereocourier.com.bd/</p>
                    </div>
                </div>
            </div> */}
                        ...
                        <form
                            onSubmit={(event) => {
                                ...
                                let TrackingMessagePost = {
                                    userOrderIdTracking: InVoiceData?.StandardParcelId,
                                    TrackingMessage,
                                    TrackingDate: date,
                                    TrackingTime: time
                                };
