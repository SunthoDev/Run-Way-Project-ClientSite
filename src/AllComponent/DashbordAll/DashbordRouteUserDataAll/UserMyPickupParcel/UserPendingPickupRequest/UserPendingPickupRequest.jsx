...
import "./UserPendingPickupRequest.css"
import { useQuery } from '@tanstack/react-query';

const UserPendingPickupRequest = ({ PendingData }) => {

    // console.log(PendingData)
    let { _id, Address, BusinessName, Districts, LastName, Phone, PickReqUserEmail, PickupIdUser, PoliceStations, UserPickupReqDate, name, photo, status, userId } = PendingData
    ...
    return (
        <div className='UserPendingPickupRequest'>

            <div className='PendingPickupRequest'>
...
export default UserPendingPickupRequest;