...
import "./UserApprovedPickupRequest.css"
import { useQuery } from '@tanstack/react-query';

const UserApprovedPickupRequest = ({ ApprovedData }) => {
    console.log(ApprovedData)
    let { _id, Address, BusinessName, Districts, LastName, Phone, PickReqUserEmail, PickupIdUser, PoliceStations, UserPickupReqDate, name, photo, status, userId,parcelNum} = ApprovedData
    ...
    // ================================================
    return (
        <div className='UserApprovedPickupRequest'>

            <div className='ApprovedPickupRequest'>
                ...
                <div className="ApprovedAllData grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                    ...
                    <div className="Three">
                        ...
                        <div className="flex items-center">
                            <h3>Total Parcel :</h3>
                            <button className='ParcelNumber'>{ApprovedData?.parcelNum ? ApprovedData.parcelNum : "0"  }</button>
                        </div>
...
export default UserApprovedPickupRequest;