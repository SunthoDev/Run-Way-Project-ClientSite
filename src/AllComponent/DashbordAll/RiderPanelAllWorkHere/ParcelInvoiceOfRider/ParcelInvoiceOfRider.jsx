...
import "./ParcelInvoiceOfRider.css"
...
const ParcelInvoiceOfRider = () => {
    ...
    return (
        <div className='ParcelInvoiceOfRider bg-white min-h-screen px-4 md:px-10 py-6'>
...
export default ParcelInvoiceOfRider;