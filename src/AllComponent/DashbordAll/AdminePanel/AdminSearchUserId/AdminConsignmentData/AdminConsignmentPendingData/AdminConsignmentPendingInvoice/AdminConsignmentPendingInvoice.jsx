...
import AdminSendAllTrackingMessageTemporery from '../../../../../DashbordRouteUserDataAll/UserTemporeryInvoiceAllStandardData/AdminSendAllTrackingMessageTemporery/AdminSendAllTrackingMessageTemporery';
...
const AdminConsignmentPendingInvoice = () => {
    ...
    return (
        <div className='AdminConsignmentPendingInvoiceParent bg-white min-h-screen px-4 md:px-10 py-6'>
            ...
            <div className="">
                ...
                <div className="flex flex-wrap justify-end gap-3 mb-6">
                    ...
                    <Link to={`/dashboard/AdminDashboard/AdminConsignmentPendingInvoiceUpdate/${_id}`} className="bg-[#22A197] text-white font-semibold px-4 py-2 rounded">Edit</Link>
                </div>

                {/* Parcel Invoice All Data Here */}
                {/* ====================================== */}
                <div className="border border-gray-200 rounded-lg p-6 shadow-sm">
                    ...
                    {/* ================================================ */}
                    {/* Tracking Rider Information Here !! */}
                    {/* ================================================ */}
            ...
            <div className="border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <div className="trackingMessageShow w-[100%] md:w-[60%]">
                    {/* It is import from user panel of invoice for (short cart) */}
                    {
