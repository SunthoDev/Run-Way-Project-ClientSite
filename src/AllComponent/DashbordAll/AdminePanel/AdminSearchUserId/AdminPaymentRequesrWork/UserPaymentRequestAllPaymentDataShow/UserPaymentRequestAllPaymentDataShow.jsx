...
import "./UserPaymentRequestAllPaymentDataShow.css"

const UserPaymentRequestAllPaymentDataShow = ({ PaymentStandardDataAll }) => {
    ...
    return (
        <div className='UserPaymentRequestAllPaymentDataShow'>
...
export default UserPaymentRequestAllPaymentDataShow;