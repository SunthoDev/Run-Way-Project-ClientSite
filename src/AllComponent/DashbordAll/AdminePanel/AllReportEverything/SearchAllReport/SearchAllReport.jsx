...
const SearchAllReport = () => {
    ...
    const { ReportSearchDate } = useContext(AuthContext);
    ...
    // =================================================
    const todayParcelData = AllParcelData?.filter(parcel => parcel.date === ReportSearchDate);
    ...
    // =================================================
    const todayPickupRequestData = AllPickupRequest?.filter(Pickup => Pickup?.date === ReportSearchDate);
    ...
    // =================================================
    const todayReturnParcelData = AllReturnParcelData?.filter(Return => Return?.date === ReportSearchDate);
    ...
    // =================================================
    const todayDispatchParcelData = AllDispatchParcelData?.filter(Dispatch => Dispatch?.date === ReportSearchDate);
    ...
    // =================================================
    const todayAddBalanceRequestData = AddBalanceRequestData?.filter(AddBalance => AddBalance?.date === ReportSearchDate);
    ...
    // =========================================================
    const todayBalanceRequestData = AllBalanceRequestDataOfParcel?.filter(PaymentRequest => PaymentRequest?.date === ReportSearchDate);
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white py-10 px-4 md:px-20">
            ...
            <div className="AllReportParent" ref={InvoiceRef}>
                <h1 className="text-4xl font-bold mb-10 text-center">🚀 Courier Report find to search !!</h1>
...
export default SearchAllReport;