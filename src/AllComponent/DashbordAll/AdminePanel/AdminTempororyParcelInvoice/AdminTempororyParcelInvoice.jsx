...
import './AdminTempororyParcelInvoice.css'
import { useLoaderData } from 'react-router-dom';

const AdminTempororyParcelInvoice = () => {
    ...
    return (
        <div className='AdminSearchStandardParcelUser px-2 md:px-10 py-10'>
            ...
            <div className="StandardMain bg-white rounded-[8px] p-[28px]">
                ...
                <h2 className='bg-[#22A197] text-left font-[600] text-white py-[12px] px-[22px] text-[16px] rounded-[8px]'>Please mention this Consignment ID ({StandardParcelId}) on parcel.</h2>

                <div className="flex justify-center gap-3 mt-8">
                    <button className='text-black bg-[#ffc107] py-[8px] px-[13px] text-[16px] rounded-[7px]  font-[500]'>Print this Order</button>
                    <button className='text-white bg-[#22A197] rounded-[7px] py-[8px] px-[13px] text-[16px] font-[500]'>New Order</button>
                </div>
                ...
                <h3 className='text-[16px] font-[500] text-black'>{StandardEmailUser}</h3>
...
export default AdminTempororyParcelInvoice;